...
[p,gof] = fit(log_box_sizes', log_N_boxes','poly1');
...
hold on;
plot(log_box_sizes, p(log_box_sizes), 'r-','LineWidth',1.5);
...
text(log_box_sizes(floor(i/2)),p(log_box_sizes(floor(i/2))),latexf,'Interpreter','latex','FontSize',14, ...
